...
CREATE TABLE IF NOT EXISTS game_repo_bindings (
    ...
    repo_full_name TEXT NOT NULL,         -- 完整仓库名 (如 'TJDominos/Gamecreator')
    default_branch TEXT DEFAULT 'main',   -- 监听分支
    sync_token_hash TEXT NOT NULL,        -- RANDSEED_API_TOKEN 的安全摘要
...
CREATE TABLE IF NOT EXISTS game_deployments (
    ...
    trigger_type TEXT DEFAULT 'github_action',-- 触发方式 ('github_action', 'webhook', 'manual')
