...
// Insert RacingHUD component before DeveloperLanding
const exportIndex = code.indexOf('export default function DeveloperLanding');
code = code.substring(0, exportIndex) + hudCode + '\n' + code.substring(exportIndex);

// Replace the hardcoded HUD with <RacingHUD />
const regex = /<div className="racing-hud">[\s\S]*?<div className="landing-container relative-z">/m;
code = code.replace(regex, '<RacingHUD />\n          <div className="landing-container relative-z">');
